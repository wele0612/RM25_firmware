##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.6.0.1-B1] date: [Fri Jun 12 19:47:57 CST 2026] 
##########################################################################################################################
...
$(wildcard ./Application/Src/vision/*.c) \
...
# 调试信息（可选）
# $(info Building with sources:)
# $(foreach src,$(C_SOURCES),$(info - $(src)))
# $(info Object files:)
# $(foreach obj,$(OBJECTS),$(info - $(obj)))
